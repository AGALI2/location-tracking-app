  ...
  return (
    <div className={styles['container']}>
      <div className={styles['header']}>
        ...
        >
          <span className={projectStyles['logo']}>TRACKER</span>
          ...
          <div className={styles['container1']}>
            ...
            >
              <span>
                <span>
                  <span>
                    Stay connected and informed with our location tracking app
                  </span>
                  <span>
                    <span
        ...
        <div className={projectStyles['features-container']}>
          <div className={styles['features1']}>
            <div className={styles['container2']}>
              ...
              >
                Key Features of Our Location Tracking App
              </h2>
              <span
            ...
            <div className={styles['container3']}>
              <FeatureCard
                ...
                subHeading="Track the location of your loved ones in real-time"
              ></FeatureCard>
              <FeatureCard
                heading="Geofencing Alerts"
                subHeading="Receive alerts when someone enters or leaves a designated area"
              ></FeatureCard>
              <FeatureCard
                heading="Location History"
                subHeading="View a detailed history of locations visited by the tracked individual"
              ></FeatureCard>
              <FeatureCard
                heading="Multiple Device Support"
                subHeading="Track and manage multiple devices from one account"
              ></FeatureCard>
            </div>
          </div>
        </div>
      ...
      <div className={styles['footer']}>
        ...
        >
          ...
          <div className={styles['container5']}>
            <span
              className={` ${projectStyles['body-small']} ${styles['text31']} `}
            >
